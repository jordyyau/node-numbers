...
import {
  ...
  rateCenterSearchResultSchema,
} from './rateCenterSearchResult';
...
export interface RateCenterSearchResults {
  searchError?: SearchError;
  resultSet?: RateCenterSearchResult[];
  resultSize?: number;
  status?: IrisStatus;
...
export const rateCenterSearchResultsSchema: Schema<RateCenterSearchResults> = object(
  {
    searchError: [
      'searchError',
    ...
    resultSet: [
      ...
      optional(
        array(
          lazy(() => rateCenterSearchResultSchema),
          { xmlItemName: 'RateCenter' }
        )
      ),
      { xmlName: 'RateCenters' },
    ],
